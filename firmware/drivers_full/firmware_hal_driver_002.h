#ifndef FW_HAL_DRIVER_002_H
#define FW_HAL_DRIVER_002_H

/**
 * @file firmware_hal_driver_002.h
 * @brief Industrial Embedded HAL Driver 002
...
typedef enum {
    HAL_STATUS_OK_002 = 0,
    HAL_STATUS_ERROR_002 = -1,
    HAL_STATUS_BUSY_002 = -2
} hal_status_002_t;
