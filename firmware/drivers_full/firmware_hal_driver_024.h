#ifndef FW_HAL_DRIVER_024_H
#define FW_HAL_DRIVER_024_H

/**
 * @file firmware_hal_driver_024.h
 * @brief Industrial Embedded HAL Driver 024
...
typedef enum {
    HAL_STATUS_OK_024 = 0,
    HAL_STATUS_ERROR_024 = -1,
    HAL_STATUS_BUSY_024 = -2
} hal_status_024_t;
