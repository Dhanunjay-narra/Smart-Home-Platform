#ifndef FW_HAL_DRIVER_033_H
#define FW_HAL_DRIVER_033_H

/**
 * @file firmware_hal_driver_033.h
 * @brief Industrial Embedded HAL Driver 033
...
typedef enum {
    HAL_STATUS_OK_033 = 0,
    HAL_STATUS_ERROR_033 = -1,
    HAL_STATUS_BUSY_033 = -2
} hal_status_033_t;
