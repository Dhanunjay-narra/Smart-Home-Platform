#ifndef FW_HAL_DRIVER_057_H
#define FW_HAL_DRIVER_057_H

/**
 * @file firmware_hal_driver_057.h
 * @brief Industrial Embedded HAL Driver 057
...
typedef enum {
    HAL_STATUS_OK_057 = 0,
    HAL_STATUS_ERROR_057 = -1,
    HAL_STATUS_BUSY_057 = -2
} hal_status_057_t;
