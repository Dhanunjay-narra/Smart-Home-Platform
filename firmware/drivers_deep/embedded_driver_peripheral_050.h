#ifndef DRIVER_PERIPHERAL_050_H
#define DRIVER_PERIPHERAL_050_H

/**
 * @file embedded_driver_peripheral_050.h
 * @brief Embedded Hardware Driver 050 for High-Reliability Smart Home Nodes
