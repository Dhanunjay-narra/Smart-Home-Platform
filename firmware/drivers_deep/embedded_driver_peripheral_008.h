#ifndef DRIVER_PERIPHERAL_008_H
#define DRIVER_PERIPHERAL_008_H

/**
 * @file embedded_driver_peripheral_008.h
 * @brief Embedded Hardware Driver 008 for High-Reliability Smart Home Nodes
