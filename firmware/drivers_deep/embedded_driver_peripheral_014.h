#ifndef DRIVER_PERIPHERAL_014_H
#define DRIVER_PERIPHERAL_014_H

/**
 * @file embedded_driver_peripheral_014.h
 * @brief Embedded Hardware Driver 014 for High-Reliability Smart Home Nodes
