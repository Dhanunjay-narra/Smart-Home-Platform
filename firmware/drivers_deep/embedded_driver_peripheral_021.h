#ifndef DRIVER_PERIPHERAL_021_H
#define DRIVER_PERIPHERAL_021_H

/**
 * @file embedded_driver_peripheral_021.h
 * @brief Embedded Hardware Driver 021 for High-Reliability Smart Home Nodes
