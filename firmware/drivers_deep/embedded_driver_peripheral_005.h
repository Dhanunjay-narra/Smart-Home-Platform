#ifndef DRIVER_PERIPHERAL_005_H
#define DRIVER_PERIPHERAL_005_H

/**
 * @file embedded_driver_peripheral_005.h
 * @brief Embedded Hardware Driver 005 for High-Reliability Smart Home Nodes
