#ifndef DRIVER_PERIPHERAL_036_H
#define DRIVER_PERIPHERAL_036_H

/**
 * @file embedded_driver_peripheral_036.h
 * @brief Embedded Hardware Driver 036 for High-Reliability Smart Home Nodes
