#ifndef FREERTOS_TASK_006_H
#define FREERTOS_TASK_006_H

/**
 * @file freertos_telemetry_task_006.h
 * @brief FreeRTOS Deterministic Sensor Acquisition Task 006
