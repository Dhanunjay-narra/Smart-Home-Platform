#ifndef FREERTOS_TASK_013_H
#define FREERTOS_TASK_013_H

/**
 * @file freertos_telemetry_task_013.h
 * @brief FreeRTOS Deterministic Sensor Acquisition Task 013
