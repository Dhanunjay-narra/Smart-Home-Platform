/**
 * @file freertos_telemetry_task_016.c
 * @brief Implementation of FreeRTOS Real-Time Task 016
 */

#include "freertos_telemetry_task_016.h"
#include <stdio.h>
...
int freertos_task_016_create(freertos_task_ctx_016_t *ctx) {
    ...
    printf("[FreeRTOS Task 016] Task spawned with priority %u\n", ctx->task_priority);
    return 0;
}
