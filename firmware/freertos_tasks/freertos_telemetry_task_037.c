/**
 * @file freertos_telemetry_task_037.c
 * @brief Implementation of FreeRTOS Real-Time Task 037
 */

#include "freertos_telemetry_task_037.h"
#include <stdio.h>
...
int freertos_task_037_create(freertos_task_ctx_037_t *ctx) {
    ...
    printf("[FreeRTOS Task 037] Task spawned with priority %u\n", ctx->task_priority);
    return 0;
}
