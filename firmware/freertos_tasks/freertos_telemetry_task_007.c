/**
 * @file freertos_telemetry_task_007.c
 * @brief Implementation of FreeRTOS Real-Time Task 007
 */

#include "freertos_telemetry_task_007.h"
#include <stdio.h>
...
int freertos_task_007_create(freertos_task_ctx_007_t *ctx) {
    ...
    printf("[FreeRTOS Task 007] Task spawned with priority %u\n", ctx->task_priority);
    return 0;
}
