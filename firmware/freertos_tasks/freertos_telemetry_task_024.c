/**
 * @file freertos_telemetry_task_024.c
 * @brief Implementation of FreeRTOS Real-Time Task 024
 */

#include "freertos_telemetry_task_024.h"
#include <stdio.h>
...
int freertos_task_024_create(freertos_task_ctx_024_t *ctx) {
    ...
    printf("[FreeRTOS Task 024] Task spawned with priority %u\n", ctx->task_priority);
    return 0;
}
