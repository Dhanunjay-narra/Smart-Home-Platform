/**
 * @file freertos_telemetry_task_040.c
 * @brief Implementation of FreeRTOS Real-Time Task 040
 */

#include "freertos_telemetry_task_040.h"
#include <stdio.h>
...
int freertos_task_040_create(freertos_task_ctx_040_t *ctx) {
    ...
    printf("[FreeRTOS Task 040] Task spawned with priority %u\n", ctx->task_priority);
    return 0;
}
