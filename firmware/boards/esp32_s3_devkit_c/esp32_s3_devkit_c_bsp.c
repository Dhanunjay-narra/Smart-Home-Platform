/**
 * @file esp32_s3_devkit_c_bsp.c
 * @brief Implementation for Espressif ESP32-S3-DevKitC-1 Dual-Core 240MHz Wi-Fi & BLE 5
 */

#include "esp32_s3_devkit_c_bsp.h"
#include <stdio.h>

int esp32_s3_devkit_c_bsp_init(void) {
    printf("[BSP Init] Espressif ESP32-S3-DevKitC-1 Dual-Core 240MHz Wi-Fi & BLE 5 initialized successfully.\n");
    return 0;
}
