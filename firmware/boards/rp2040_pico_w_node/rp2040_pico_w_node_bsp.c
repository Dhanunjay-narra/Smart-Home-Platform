/**
 * @file rp2040_pico_w_node_bsp.c
 * @brief Implementation for Raspberry Pi Pico W Dual Cortex-M0+ Wireless Sensor Node
 */

#include "rp2040_pico_w_node_bsp.h"
#include <stdio.h>

int rp2040_pico_w_node_bsp_init(void) {
    printf("[BSP Init] Raspberry Pi Pico W Dual Cortex-M0+ Wireless Sensor Node initialized successfully.\n");
    return 0;
}
