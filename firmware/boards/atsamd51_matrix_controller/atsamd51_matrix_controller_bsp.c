/**
 * @file atsamd51_matrix_controller_bsp.c
 * @brief Implementation for Microchip ATSAMD51J19A 120MHz Cortex-M4F RGB LED Controller
 */

#include "atsamd51_matrix_controller_bsp.h"
#include <stdio.h>

int atsamd51_matrix_controller_bsp_init(void) {
    printf("[BSP Init] Microchip ATSAMD51J19A 120MHz Cortex-M4F RGB LED Controller initialized successfully.\n");
    return 0;
}
