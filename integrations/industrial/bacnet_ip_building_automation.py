"""
Smart Home Platform Core Subsystem: BacnetIpBuildingAutomationComponent
Description: BACnet/IP BBMD Foreign Device Registration & Object Table
"""
...
class BacnetIpBuildingAutomationComponentMetadata(BaseModel):
    subsystem_id: str = "bacnet_ip_building_automation"
    display_name: str = "Bacnet Ip Building Automation"
    description: str = "BACnet/IP BBMD Foreign Device Registration & Object Table"
    version: str = '2.4.0'
    is_active: bool = True
...
class BacnetIpBuildingAutomationComponentMetrics(BaseModel):
...
class BacnetIpBuildingAutomationComponent:
    """Enterprise Production Class implementing BACnet/IP BBMD Foreign Device Registration & Object Table."""
    def __init__(self, node_id: str = 'node-primary-01'):
        self.node_id = node_id
        self.metadata = BacnetIpBuildingAutomationComponentMetadata()
        self.metrics = BacnetIpBuildingAutomationComponentMetrics()
