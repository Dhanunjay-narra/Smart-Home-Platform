"""
Smart Home Platform — Protocol Codec: CoapBlockwiseOtaCodec
Standard: CoAP RFC 7959 Block1 / Block2 transfer protocol for low-power OTA firmware updates
"""
...
class CoapBlockwiseOtaCodec:
    """High-performance binary & text protocol serializer/deserializer for CoAP RFC 7959 Block1 / Block2 transfer protocol for low-power OTA firmware updates."""
