"""
Smart Home Platform — Protocol Codec: ModbusRtuInverterCodec
Standard: Modbus RTU master implementation for solar PV inverters and charge controllers
"""
...
class ModbusRtuInverterCodec:
    """High-performance binary & text protocol serializer/deserializer for Modbus RTU master implementation for solar PV inverters and charge controllers."""
