"""
Smart Home Platform — Protocol Codec: ZigbeeZclThermostatCodec
Standard: Zigbee Cluster Library (ZCL) Thermostat Cluster 0x0201 HVAC setpoint handler
"""
...
class ZigbeeZclThermostatCodec:
    """High-performance binary & text protocol serializer/deserializer for Zigbee Cluster Library (ZCL) Thermostat Cluster 0x0201 HVAC setpoint handler."""
