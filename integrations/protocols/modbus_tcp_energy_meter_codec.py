"""
Smart Home Platform — Protocol Codec: ModbusTcpEnergyMeterCodec
Standard: Modbus TCP client for 3-phase grid power meters and multi-function transducers
"""
...
class ModbusTcpEnergyMeterCodec:
    """High-performance binary & text protocol serializer/deserializer for Modbus TCP client for 3-phase grid power meters and multi-function transducers."""
