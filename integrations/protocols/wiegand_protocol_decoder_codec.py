"""
Smart Home Platform — Protocol Codec: WiegandProtocolDecoderCodec
Standard: Wiegand 26/34/37 bit binary pulse stream parity checker and facility code parser
"""
...
class WiegandProtocolDecoderCodec:
    """High-performance binary & text protocol serializer/deserializer for Wiegand 26/34/37 bit binary pulse stream parity checker and facility code parser."""
