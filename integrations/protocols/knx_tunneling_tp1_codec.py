"""
Smart Home Platform — Protocol Codec: KnxTunnelingTp1Codec
Standard: KNXnet/IP Tunneling v1.2 cEMI frame encoder for Twisted Pair 1 (TP1) installations
"""
...
class KnxTunnelingTp1Codec:
    """High-performance binary & text protocol serializer/deserializer for KNXnet/IP Tunneling v1.2 cEMI frame encoder for Twisted Pair 1 (TP1) installations."""
