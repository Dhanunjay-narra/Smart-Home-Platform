"""
Smart Home Platform — Protocol Codec: ZigbeeZclLevelControlCodec
Standard: Zigbee Cluster Library (ZCL) Level Control Cluster 0x0008 dimming handler
"""
...
class ZigbeeZclLevelControlCodec:
    """High-performance binary & text protocol serializer/deserializer for Zigbee Cluster Library (ZCL) Level Control Cluster 0x0008 dimming handler."""
