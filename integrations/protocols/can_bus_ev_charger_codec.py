"""
Smart Home Platform — Protocol Codec: CanBusEvChargerCodec
Standard: CANopen interface for high-power DC fast charging stations and vehicle battery packs
"""
...
class CanBusEvChargerCodec:
    """High-performance binary & text protocol serializer/deserializer for CANopen interface for high-power DC fast charging stations and vehicle battery packs."""
