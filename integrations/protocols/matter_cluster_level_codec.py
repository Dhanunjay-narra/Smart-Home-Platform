"""
Smart Home Platform — Protocol Codec: MatterClusterLevelCodec
Standard: Matter Data Model Level Control Cluster (0x0008) endpoint translator
"""
...
class MatterClusterLevelCodec:
    """High-performance binary & text protocol serializer/deserializer for Matter Data Model Level Control Cluster (0x0008) endpoint translator."""
