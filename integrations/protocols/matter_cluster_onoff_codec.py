"""
Smart Home Platform — Protocol Codec: MatterClusterOnoffCodec
Standard: Matter Data Model On/Off Cluster (0x0006) protocol endpoint translator
"""
...
class MatterClusterOnoffCodec:
    """High-performance binary & text protocol serializer/deserializer for Matter Data Model On/Off Cluster (0x0006) protocol endpoint translator."""
