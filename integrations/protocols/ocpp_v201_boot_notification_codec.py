"""
Smart Home Platform — Protocol Codec: OcppV201BootNotificationCodec
Standard: Open Charge Point Protocol 2.0.1 BootNotification and Heartbeat WebSocket codec
"""
...
class OcppV201BootNotificationCodec:
    """High-performance binary & text protocol serializer/deserializer for Open Charge Point Protocol 2.0.1 BootNotification and Heartbeat WebSocket codec."""
