"""
Smart Home Platform — Protocol Codec: ZigbeeZclColorControlCodec
Standard: Zigbee Cluster Library (ZCL) Color Control Cluster 0x0300 CIE xy and CCT handler
"""
...
class ZigbeeZclColorControlCodec:
    """High-performance binary & text protocol serializer/deserializer for Zigbee Cluster Library (ZCL) Color Control Cluster 0x0300 CIE xy and CCT handler."""
