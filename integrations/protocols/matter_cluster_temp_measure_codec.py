"""
Smart Home Platform — Protocol Codec: MatterClusterTempMeasureCodec
Standard: Matter Temperature Measurement Cluster (0x0402) telemetry translator
"""
...
class MatterClusterTempMeasureCodec:
    """High-performance binary & text protocol serializer/deserializer for Matter Temperature Measurement Cluster (0x0402) telemetry translator."""
