# Spatial Graph Schema: Property, Buildings, Floors, Rooms, and Zones

**Document ID:** SPEC-03_SPATIAL_TOPOLOGY_DATA_MODEL  
**Version:** 2.4.0  
...
This document specifies the technical design, protocols, schemas, and operational constraints for the **Spatial Graph Schema: Property, Buildings, Floors, Rooms, and Zones** within the unified Smart Home Platform ecosystem.
...
```json
{
  "spec_id": "03_spatial_topology_data_model",
  "version": "2.4.0",
