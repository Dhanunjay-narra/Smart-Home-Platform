# Energy Management RFC: Solar MPPT Inverters, Battery BSS & Smart EV Charging

**Document ID:** SPEC-11_ENERGY_SOLAR_BATTERY_EV_ORCHESTRATION  
**Version:** 2.4.0  
...
This document specifies the technical design, protocols, schemas, and operational constraints for the **Energy Management RFC: Solar MPPT Inverters, Battery BSS & Smart EV Charging** within the unified Smart Home Platform ecosystem.
...
```json
{
  "spec_id": "11_energy_solar_battery_ev_orchestration",
  "version": "2.4.0",
