"""
Protocol Adapter: ModbusTcpCodec
Standard: Modbus TCP MBAP Header and PDU Stream Parser
"""
...
class ModbusTcpCodec:
    """Industrial & IoT Protocol implementation for Modbus TCP MBAP Header and PDU Stream Parser."""
