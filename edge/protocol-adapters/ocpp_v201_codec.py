"""
Protocol Adapter: OcppV201Codec
Standard: Open Charge Point Protocol (OCPP 2.0.1) JSON WebSocket Codec
"""
...
class OcppV201Codec:
    """Industrial & IoT Protocol implementation for Open Charge Point Protocol (OCPP 2.0.1) JSON WebSocket Codec."""
