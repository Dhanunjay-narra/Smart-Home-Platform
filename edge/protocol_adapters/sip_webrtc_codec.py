"""
Protocol Adapter: SipWebrtcCodec
Standard: Session Initiation Protocol (SIP) SDP and WebRTC ICE Signaling Codec
"""
...
class SipWebrtcCodec:
    """Industrial & IoT Protocol implementation for Session Initiation Protocol (SIP) SDP and WebRTC ICE Signaling Codec."""
