"""
Protocol Adapter: KnxNetIpCodec
Standard: KNX/EIB Tunneling & Routing Building Automation IP Codec
"""
...
class KnxNetIpCodec:
    """Industrial & IoT Protocol implementation for KNX/EIB Tunneling & Routing Building Automation IP Codec."""
