"""
Protocol Adapter: OnvifPtzCodec
Standard: ONVIF Profile S/T Video PTZ and Event Notification XML Codec
"""
...
class OnvifPtzCodec:
    """Industrial & IoT Protocol implementation for ONVIF Profile S/T Video PTZ and Event Notification XML Codec."""
