"""
Protocol Adapter: ModbusRtuCodec
Standard: Modbus RTU Master/Slave CRC16 Frame Encoder/Decoder
"""
...
class ModbusRtuCodec:
    """Industrial & IoT Protocol implementation for Modbus RTU Master/Slave CRC16 Frame Encoder/Decoder."""
