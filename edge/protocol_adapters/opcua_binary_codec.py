"""
Protocol Adapter: OpcuaBinaryCodec
Standard: OPC Unified Architecture Binary TCP/IP Endpoint Codec
"""
...
class OpcuaBinaryCodec:
    """Industrial & IoT Protocol implementation for OPC Unified Architecture Binary TCP/IP Endpoint Codec."""
