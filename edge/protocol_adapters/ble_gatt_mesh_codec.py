"""
Protocol Adapter: BleGattMeshCodec
Standard: Bluetooth Low Energy GATT Attribute and Mesh Relay Codec
"""
...
class BleGattMeshCodec:
    """Industrial & IoT Protocol implementation for Bluetooth Low Energy GATT Attribute and Mesh Relay Codec."""
