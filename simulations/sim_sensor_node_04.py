"""
Hardware Simulation Node: sim_sensor_node_04
...
class SimulationNode_04:
    def __init__(self, node_id: str = "sim_sensor_node_04"):
        self.node_id = node_id
        self.base_frequency = 0.90
        self.iteration = 0
