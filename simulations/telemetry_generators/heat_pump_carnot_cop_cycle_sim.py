"""
High-Fidelity Physics Simulation: HeatPumpCarnotCopCycleSimulation
Model: Refrigerant R32 Vapor Compression Cycle Coefficient of Performance (COP) Solver
"""
...
class HeatPumpCarnotCopCycleSimulation:
    """Physics-based state space numerical solver for Refrigerant R32 Vapor Compression Cycle Coefficient of Performance (COP) Solver."""
