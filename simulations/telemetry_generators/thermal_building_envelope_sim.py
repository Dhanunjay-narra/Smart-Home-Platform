"""
High-Fidelity Physics Simulation: ThermalBuildingEnvelopeSimulation
Model: Multi-Zone Transient Heat Conduction and Solar Heat Gain Coefficient (SHGC) Model
"""
...
class ThermalBuildingEnvelopeSimulation:
    """Physics-based state space numerical solver for Multi-Zone Transient Heat Conduction and Solar Heat Gain Coefficient (SHGC) Model."""
