"""
High-Fidelity Physics Simulation: DieselGeneratorFuelRateSimulation
Model: Standby Generator Brake Specific Fuel Consumption (BSFC) and Load Curve Model
"""
...
class DieselGeneratorFuelRateSimulation:
    """Physics-based state space numerical solver for Standby Generator Brake Specific Fuel Consumption (BSFC) and Load Curve Model."""
