"""
Hardware Simulation Node: sim_sensor_node_03
...
class SimulationNode_03:
    def __init__(self, node_id: str = "sim_sensor_node_03"):
        self.node_id = node_id
        self.base_frequency = 0.80
        self.iteration = 0
