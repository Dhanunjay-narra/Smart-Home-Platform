"""
Smart Home Platform Core Subsystem: EvSmartChargeSurplusDivertComponent
Description: Dynamic EVSE Charging Amperage Regulation from 6A to 32A
"""
...
class EvSmartChargeSurplusDivertComponentMetadata(BaseModel):
    subsystem_id: str = "ev_smart_charge_surplus_divert"
    display_name: str = "Ev Smart Charge Surplus Divert"
    description: str = "Dynamic EVSE Charging Amperage Regulation from 6A to 32A"
    version: str = '2.4.0'
    is_active: bool = True
...
class EvSmartChargeSurplusDivertComponentMetrics(BaseModel):
...
class EvSmartChargeSurplusDivertComponent:
    """Enterprise Production Class implementing Dynamic EVSE Charging Amperage Regulation from 6A to 32A."""
    def __init__(self, node_id: str = 'node-primary-01'):
        self.node_id = node_id
        self.metadata = EvSmartChargeSurplusDivertComponentMetadata()
        self.metrics = EvSmartChargeSurplusDivertComponentMetrics()
