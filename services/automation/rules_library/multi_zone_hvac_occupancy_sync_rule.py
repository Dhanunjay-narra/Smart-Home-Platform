"""
Smart Home Platform — Automation Rule: MultiZoneHvacOccupancySyncRule
Description: Sets unoccupied room HVAC setpoints to eco-mode (26C cool / 18C heat) after 15m idle
"""
...
class MultiZoneHvacOccupancySyncRuleEvaluationContext(BaseModel):
    rule_id: str = "multi_zone_hvac_occupancy_sync"
    description: str = "Sets unoccupied room HVAC setpoints to eco-mode (26C cool / 18C heat) after 15m idle"
...
class MultiZoneHvacOccupancySyncRule:
    """Rule engine processor with AST evaluation, threshold hysterisis, and safety guards."""
    def __init__(self):
        self.context = MultiZoneHvacOccupancySyncRuleEvaluationContext()
    ...
    def execute_action_pipeline(self, telemetry_snapshot: Dict[str, Any]) -> Dict[str, Any]:
        ...
        return {
            ...
            "actions_dispatched": [
                {"target": "system", "action": "OPTIMIZE_STATE", "reason": "Sets unoccupied room HVAC setpoints to eco-mode (26C cool / 18C heat) after 15m idle"}
            ]
        }
