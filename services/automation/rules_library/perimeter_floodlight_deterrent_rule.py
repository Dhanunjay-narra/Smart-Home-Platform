"""
Smart Home Platform — Automation Rule: PerimeterFloodlightDeterrentRule
Description: Strobes 5000K exterior floodlights and chirps outdoor siren when human detected after midnight
"""
...
class PerimeterFloodlightDeterrentRuleEvaluationContext(BaseModel):
    rule_id: str = "perimeter_floodlight_deterrent"
    description: str = "Strobes 5000K exterior floodlights and chirps outdoor siren when human detected after midnight"
...
class PerimeterFloodlightDeterrentRule:
    """Rule engine processor with AST evaluation, threshold hysterisis, and safety guards."""
    def __init__(self):
        self.context = PerimeterFloodlightDeterrentRuleEvaluationContext()
    ...
    def execute_action_pipeline(self, telemetry_snapshot: Dict[str, Any]) -> Dict[str, Any]:
        ...
        return {
            ...
            "actions_dispatched": [
                {"target": "system", "action": "OPTIMIZE_STATE", "reason": "Strobes 5000K exterior floodlights and chirps outdoor siren when human detected after midnight"}
            ]
        }
