"""
Smart Home Platform — Automation Rule: RainSensorIrrigationBypassRule
Description: Cancels scheduled lawn sprinkler cycles if precipitation > 5mm recorded in past 24 hours
"""
...
class RainSensorIrrigationBypassRuleEvaluationContext(BaseModel):
    rule_id: str = "rain_sensor_irrigation_bypass"
    description: str = "Cancels scheduled lawn sprinkler cycles if precipitation > 5mm recorded in past 24 hours"
...
class RainSensorIrrigationBypassRule:
    """Rule engine processor with AST evaluation, threshold hysterisis, and safety guards."""
    def __init__(self):
        self.context = RainSensorIrrigationBypassRuleEvaluationContext()
    ...
    def execute_action_pipeline(self, telemetry_snapshot: Dict[str, Any]) -> Dict[str, Any]:
        ...
        return {
            ...
            "actions_dispatched": [
                {"target": "system", "action": "OPTIMIZE_STATE", "reason": "Cancels scheduled lawn sprinkler cycles if precipitation > 5mm recorded in past 24 hours"}
            ]
        }
