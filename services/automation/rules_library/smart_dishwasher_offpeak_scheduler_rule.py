"""
Smart Home Platform — Automation Rule: SmartDishwasherOffpeakSchedulerRule
Description: Delays scheduled dishwasher wash cycle until off-peak electric tariff begins at 01:00
"""
...
class SmartDishwasherOffpeakSchedulerRuleEvaluationContext(BaseModel):
    rule_id: str = "smart_dishwasher_offpeak_scheduler"
    description: str = "Delays scheduled dishwasher wash cycle until off-peak electric tariff begins at 01:00"
...
class SmartDishwasherOffpeakSchedulerRule:
    """Rule engine processor with AST evaluation, threshold hysterisis, and safety guards."""
    def __init__(self):
        self.context = SmartDishwasherOffpeakSchedulerRuleEvaluationContext()
    ...
    def execute_action_pipeline(self, telemetry_snapshot: Dict[str, Any]) -> Dict[str, Any]:
        ...
        return {
            ...
            "actions_dispatched": [
                {"target": "system", "action": "OPTIMIZE_STATE", "reason": "Delays scheduled dishwasher wash cycle until off-peak electric tariff begins at 01:00"}
            ]
        }
