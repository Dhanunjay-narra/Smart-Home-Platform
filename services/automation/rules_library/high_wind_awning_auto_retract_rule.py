"""
Smart Home Platform — Automation Rule: HighWindAwningAutoRetractRule
Description: Retracts patio fabric awnings immediately when wind gust exceeds 35 km/h
"""
...
class HighWindAwningAutoRetractRuleEvaluationContext(BaseModel):
    rule_id: str = "high_wind_awning_auto_retract"
    description: str = "Retracts patio fabric awnings immediately when wind gust exceeds 35 km/h"
...
class HighWindAwningAutoRetractRule:
    """Rule engine processor with AST evaluation, threshold hysterisis, and safety guards."""
    def __init__(self):
        self.context = HighWindAwningAutoRetractRuleEvaluationContext()
    ...
    def execute_action_pipeline(self, telemetry_snapshot: Dict[str, Any]) -> Dict[str, Any]:
        ...
        return {
            ...
            "actions_dispatched": [
                {"target": "system", "action": "OPTIMIZE_STATE", "reason": "Retracts patio fabric awnings immediately when wind gust exceeds 35 km/h"}
            ]
        }
