"""
Smart Home Platform — Automation Rule: WaterLeakAutoIsolationRule
Description: Immediately closes motorized main ball valve and sends emergency alert when floor probe wets
"""
...
class WaterLeakAutoIsolationRuleEvaluationContext(BaseModel):
    rule_id: str = "water_leak_auto_isolation"
    description: str = "Immediately closes motorized main ball valve and sends emergency alert when floor probe wets"
...
class WaterLeakAutoIsolationRule:
    """Rule engine processor with AST evaluation, threshold hysterisis, and safety guards."""
    def __init__(self):
        self.context = WaterLeakAutoIsolationRuleEvaluationContext()
    ...
    def execute_action_pipeline(self, telemetry_snapshot: Dict[str, Any]) -> Dict[str, Any]:
        ...
        return {
            ...
            "actions_dispatched": [
                {"target": "system", "action": "OPTIMIZE_STATE", "reason": "Immediately closes motorized main ball valve and sends emergency alert when floor probe wets"}
            ]
        }
