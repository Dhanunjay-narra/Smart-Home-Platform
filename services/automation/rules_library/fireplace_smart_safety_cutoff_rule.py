"""
Smart Home Platform — Automation Rule: FireplaceSmartSafetyCutoffRule
Description: Closes natural gas fireplace solenoid valve automatically if room carbon monoxide exceeds 15 ppm
"""
...
class FireplaceSmartSafetyCutoffRuleEvaluationContext(BaseModel):
    rule_id: str = "fireplace_smart_safety_cutoff"
    description: str = "Closes natural gas fireplace solenoid valve automatically if room carbon monoxide exceeds 15 ppm"
...
class FireplaceSmartSafetyCutoffRule:
    """Rule engine processor with AST evaluation, threshold hysterisis, and safety guards."""
    def __init__(self):
        self.context = FireplaceSmartSafetyCutoffRuleEvaluationContext()
    ...
    def execute_action_pipeline(self, telemetry_snapshot: Dict[str, Any]) -> Dict[str, Any]:
        ...
        return {
            ...
            "actions_dispatched": [
                {"target": "system", "action": "OPTIMIZE_STATE", "reason": "Closes natural gas fireplace solenoid valve automatically if room carbon monoxide exceeds 15 ppm"}
            ]
        }
