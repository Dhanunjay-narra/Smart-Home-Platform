"""
Smart Home Platform — Automation Rule: BedtimeSecurityPerimeterArmRule
Description: Arms perimeter security in NIGHT mode, locks all deadbolts, and verifies garage closed at 23:00
"""
...
class BedtimeSecurityPerimeterArmRuleEvaluationContext(BaseModel):
    rule_id: str = "bedtime_security_perimeter_arm"
    description: str = "Arms perimeter security in NIGHT mode, locks all deadbolts, and verifies garage closed at 23:00"
...
class BedtimeSecurityPerimeterArmRule:
    """Rule engine processor with AST evaluation, threshold hysterisis, and safety guards."""
    def __init__(self):
        self.context = BedtimeSecurityPerimeterArmRuleEvaluationContext()
    ...
    def execute_action_pipeline(self, telemetry_snapshot: Dict[str, Any]) -> Dict[str, Any]:
        ...
        return {
            ...
            "actions_dispatched": [
                {"target": "system", "action": "OPTIMIZE_STATE", "reason": "Arms perimeter security in NIGHT mode, locks all deadbolts, and verifies garage closed at 23:00"}
            ]
        }
