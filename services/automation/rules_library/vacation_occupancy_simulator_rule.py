"""
Smart Home Platform — Automation Rule: VacationOccupancySimulatorRule
Description: Randomizes evening lighting and blind movements between 19:00 and 23:00 when home is in VACATION mode
"""
...
class VacationOccupancySimulatorRuleEvaluationContext(BaseModel):
    rule_id: str = "vacation_occupancy_simulator"
    description: str = "Randomizes evening lighting and blind movements between 19:00 and 23:00 when home is in VACATION mode"
...
class VacationOccupancySimulatorRule:
    """Rule engine processor with AST evaluation, threshold hysterisis, and safety guards."""
    def __init__(self):
        self.context = VacationOccupancySimulatorRuleEvaluationContext()
    ...
    def execute_action_pipeline(self, telemetry_snapshot: Dict[str, Any]) -> Dict[str, Any]:
        ...
        return {
            ...
            "actions_dispatched": [
                {"target": "system", "action": "OPTIMIZE_STATE", "reason": "Randomizes evening lighting and blind movements between 19:00 and 23:00 when home is in VACATION mode"}
            ]
        }
