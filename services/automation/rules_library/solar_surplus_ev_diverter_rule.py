"""
Smart Home Platform — Automation Rule: SolarSurplusEvDiverterRule
Description: Directs excess PV solar generation above 3.5kW directly into EV wallbox battery charging
"""
...
class SolarSurplusEvDiverterRuleEvaluationContext(BaseModel):
    rule_id: str = "solar_surplus_ev_diverter"
    description: str = "Directs excess PV solar generation above 3.5kW directly into EV wallbox battery charging"
...
class SolarSurplusEvDiverterRule:
    """Rule engine processor with AST evaluation, threshold hysterisis, and safety guards."""
    def __init__(self):
        self.context = SolarSurplusEvDiverterRuleEvaluationContext()
    ...
    def execute_action_pipeline(self, telemetry_snapshot: Dict[str, Any]) -> Dict[str, Any]:
        ...
        return {
            ...
            "actions_dispatched": [
                {"target": "system", "action": "OPTIMIZE_STATE", "reason": "Directs excess PV solar generation above 3.5kW directly into EV wallbox battery charging"}
            ]
        }
