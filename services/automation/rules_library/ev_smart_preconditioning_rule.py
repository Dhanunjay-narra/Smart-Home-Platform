"""
Smart Home Platform — Automation Rule: EvSmartPreconditioningRule
Description: Preheats or precools EV cabin using grid power 15 minutes before scheduled calendar departure
"""
...
class EvSmartPreconditioningRuleEvaluationContext(BaseModel):
    rule_id: str = "ev_smart_preconditioning"
    description: str = "Preheats or precools EV cabin using grid power 15 minutes before scheduled calendar departure"
...
class EvSmartPreconditioningRule:
    """Rule engine processor with AST evaluation, threshold hysterisis, and safety guards."""
    def __init__(self):
        self.context = EvSmartPreconditioningRuleEvaluationContext()
    ...
    def execute_action_pipeline(self, telemetry_snapshot: Dict[str, Any]) -> Dict[str, Any]:
        ...
        return {
            ...
            "actions_dispatched": [
                {"target": "system", "action": "OPTIMIZE_STATE", "reason": "Preheats or precools EV cabin using grid power 15 minutes before scheduled calendar departure"}
            ]
        }
