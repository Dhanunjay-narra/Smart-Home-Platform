"""
Smart Home Platform — Automation Rule: BathroomHumidityExhaustTimerRule
Description: Runs bathroom exhaust fan until relative humidity drops below 55% + 5-minute overrun
"""
...
class BathroomHumidityExhaustTimerRuleEvaluationContext(BaseModel):
    rule_id: str = "bathroom_humidity_exhaust_timer"
    description: str = "Runs bathroom exhaust fan until relative humidity drops below 55% + 5-minute overrun"
...
class BathroomHumidityExhaustTimerRule:
    """Rule engine processor with AST evaluation, threshold hysterisis, and safety guards."""
    def __init__(self):
        self.context = BathroomHumidityExhaustTimerRuleEvaluationContext()
    ...
    def execute_action_pipeline(self, telemetry_snapshot: Dict[str, Any]) -> Dict[str, Any]:
        ...
        return {
            ...
            "actions_dispatched": [
                {"target": "system", "action": "OPTIMIZE_STATE", "reason": "Runs bathroom exhaust fan until relative humidity drops below 55% + 5-minute overrun"}
            ]
        }
