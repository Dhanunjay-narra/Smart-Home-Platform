"""
Smart Home Platform — Automation Rule: SolarBatteryIslandingDetectorRule
Description: Disconnects grid relay within 20ms and switches battery inverter to microgrid islanding on blackout
"""
...
class SolarBatteryIslandingDetectorRuleEvaluationContext(BaseModel):
    rule_id: str = "solar_battery_islanding_detector"
    description: str = "Disconnects grid relay within 20ms and switches battery inverter to microgrid islanding on blackout"
...
class SolarBatteryIslandingDetectorRule:
    """Rule engine processor with AST evaluation, threshold hysterisis, and safety guards."""
    def __init__(self):
        self.context = SolarBatteryIslandingDetectorRuleEvaluationContext()
    ...
    def execute_action_pipeline(self, telemetry_snapshot: Dict[str, Any]) -> Dict[str, Any]:
        ...
        return {
            ...
            "actions_dispatched": [
                {"target": "system", "action": "OPTIMIZE_STATE", "reason": "Disconnects grid relay within 20ms and switches battery inverter to microgrid islanding on blackout"}
            ]
        }
