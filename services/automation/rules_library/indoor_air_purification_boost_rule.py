"""
Smart Home Platform — Automation Rule: IndoorAirPurificationBoostRule
Description: Engages HEPA air purifiers at 100% when PM2.5 exceeds 35 ug/m3 or VOC index exceeds 200
"""
...
class IndoorAirPurificationBoostRuleEvaluationContext(BaseModel):
    rule_id: str = "indoor_air_purification_boost"
    description: str = "Engages HEPA air purifiers at 100% when PM2.5 exceeds 35 ug/m3 or VOC index exceeds 200"
...
class IndoorAirPurificationBoostRule:
    """Rule engine processor with AST evaluation, threshold hysterisis, and safety guards."""
    def __init__(self):
        self.context = IndoorAirPurificationBoostRuleEvaluationContext()
    ...
    def execute_action_pipeline(self, telemetry_snapshot: Dict[str, Any]) -> Dict[str, Any]:
        ...
        return {
            ...
            "actions_dispatched": [
                {"target": "system", "action": "OPTIMIZE_STATE", "reason": "Engages HEPA air purifiers at 100% when PM2.5 exceeds 35 ug/m3 or VOC index exceeds 200"}
            ]
        }
