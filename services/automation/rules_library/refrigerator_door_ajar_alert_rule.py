"""
Smart Home Platform — Automation Rule: RefrigeratorDoorAjarAlertRule
Description: Chimes smart speakers if refrigerator door reed switch remains open for > 90 seconds
"""
...
class RefrigeratorDoorAjarAlertRuleEvaluationContext(BaseModel):
    rule_id: str = "refrigerator_door_ajar_alert"
    description: str = "Chimes smart speakers if refrigerator door reed switch remains open for > 90 seconds"
...
class RefrigeratorDoorAjarAlertRule:
    """Rule engine processor with AST evaluation, threshold hysterisis, and safety guards."""
    def __init__(self):
        self.context = RefrigeratorDoorAjarAlertRuleEvaluationContext()
    ...
    def execute_action_pipeline(self, telemetry_snapshot: Dict[str, Any]) -> Dict[str, Any]:
        ...
        return {
            ...
            "actions_dispatched": [
                {"target": "system", "action": "OPTIMIZE_STATE", "reason": "Chimes smart speakers if refrigerator door reed switch remains open for > 90 seconds"}
            ]
        }
