"""
Smart Home Platform — Automation Rule Engine Pipeline 018
...
class AutomationRulePipeline018Context(BaseModel):
    rule_id: str = "automation_rule_pipeline_018"
    index: int = 18
    rule_priority: int = 68
