"""
Smart Home Platform — Automation Rule Engine Pipeline 026
...
class AutomationRulePipeline026Context(BaseModel):
    rule_id: str = "automation_rule_pipeline_026"
    index: int = 26
    rule_priority: int = 76
