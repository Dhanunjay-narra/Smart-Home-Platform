"""
Smart Home Platform — Automation Rule Engine Pipeline 010
...
class AutomationRulePipeline010Context(BaseModel):
    rule_id: str = "automation_rule_pipeline_010"
    index: int = 10
