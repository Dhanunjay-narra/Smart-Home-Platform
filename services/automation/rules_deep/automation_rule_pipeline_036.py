"""
Smart Home Platform — Automation Rule Engine Pipeline 036
...
class AutomationRulePipeline036Context(BaseModel):
    rule_id: str = "automation_rule_pipeline_036"
    index: int = 36
    rule_priority: int = 86
