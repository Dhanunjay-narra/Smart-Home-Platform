"""
Smart Home Platform — Automation Rule Engine Pipeline 001
...
class AutomationRulePipeline001Context(BaseModel):
    rule_id: str = "automation_rule_pipeline_001"
    index: int = 1
