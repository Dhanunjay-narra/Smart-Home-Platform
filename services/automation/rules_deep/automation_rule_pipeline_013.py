"""
Smart Home Platform — Automation Rule Engine Pipeline 013
...
class AutomationRulePipeline013Context(BaseModel):
    rule_id: str = "automation_rule_pipeline_013"
    index: int = 13
    rule_priority: int = 63
