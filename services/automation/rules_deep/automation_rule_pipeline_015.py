"""
Smart Home Platform — Automation Rule Engine Pipeline 015
...
class AutomationRulePipeline015Context(BaseModel):
    rule_id: str = "automation_rule_pipeline_015"
    index: int = 15
    rule_priority: int = 65
