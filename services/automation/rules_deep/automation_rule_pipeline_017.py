"""
Smart Home Platform — Automation Rule Engine Pipeline 017
...
class AutomationRulePipeline017Context(BaseModel):
    rule_id: str = "automation_rule_pipeline_017"
    index: int = 17
    rule_priority: int = 67
