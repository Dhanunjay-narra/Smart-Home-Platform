"""
Smart Home Platform — Automation Rule Engine Pipeline 025
...
class AutomationRulePipeline025Context(BaseModel):
    rule_id: str = "automation_rule_pipeline_025"
    index: int = 25
    rule_priority: int = 75
