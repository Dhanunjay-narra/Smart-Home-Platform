"""
Smart Home Platform — Automation Rule Engine Pipeline 021
...
class AutomationRulePipeline021Context(BaseModel):
    rule_id: str = "automation_rule_pipeline_021"
    index: int = 21
    rule_priority: int = 71
