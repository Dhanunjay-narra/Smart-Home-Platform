"""
Smart Home Platform — Automation Rule Engine Pipeline 012
...
class AutomationRulePipeline012Context(BaseModel):
    rule_id: str = "automation_rule_pipeline_012"
    index: int = 12
    rule_priority: int = 62
