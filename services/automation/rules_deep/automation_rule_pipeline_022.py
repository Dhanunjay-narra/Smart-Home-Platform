"""
Smart Home Platform — Automation Rule Engine Pipeline 022
...
class AutomationRulePipeline022Context(BaseModel):
    rule_id: str = "automation_rule_pipeline_022"
    index: int = 22
    rule_priority: int = 72
