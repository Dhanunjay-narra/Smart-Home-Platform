"""
Smart Home Platform — Automation Rule Engine Pipeline 004
...
class AutomationRulePipeline004Context(BaseModel):
    rule_id: str = "automation_rule_pipeline_004"
    index: int = 4
