"""
Smart Home Platform — Automation Rule Engine Pipeline 005
...
class AutomationRulePipeline005Context(BaseModel):
    rule_id: str = "automation_rule_pipeline_005"
    index: int = 5
    rule_priority: int = 55
