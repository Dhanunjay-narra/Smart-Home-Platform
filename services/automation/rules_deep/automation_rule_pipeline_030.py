"""
Smart Home Platform — Automation Rule Engine Pipeline 030
...
class AutomationRulePipeline030Context(BaseModel):
    rule_id: str = "automation_rule_pipeline_030"
    index: int = 30
    rule_priority: int = 80
