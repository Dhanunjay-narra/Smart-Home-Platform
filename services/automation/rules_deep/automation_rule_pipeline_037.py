"""
Smart Home Platform — Automation Rule Engine Pipeline 037
...
class AutomationRulePipeline037Context(BaseModel):
    rule_id: str = "automation_rule_pipeline_037"
    index: int = 37
    rule_priority: int = 87
