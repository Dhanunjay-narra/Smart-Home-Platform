"""
Smart Home Platform — Automation Rule Engine Pipeline 011
...
class AutomationRulePipeline011Context(BaseModel):
    rule_id: str = "automation_rule_pipeline_011"
    index: int = 11
    rule_priority: int = 61
