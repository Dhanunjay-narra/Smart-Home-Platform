"""
Smart Home Platform — Automation Rule Engine Pipeline 060
...
class AutomationRulePipeline060Context(BaseModel):
    rule_id: str = "automation_rule_pipeline_060"
    index: int = 60
    rule_priority: int = 60
