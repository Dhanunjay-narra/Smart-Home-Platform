"""
Smart Home Platform — Automation Rule Engine Pipeline 027
...
class AutomationRulePipeline027Context(BaseModel):
    rule_id: str = "automation_rule_pipeline_027"
    index: int = 27
    rule_priority: int = 77
