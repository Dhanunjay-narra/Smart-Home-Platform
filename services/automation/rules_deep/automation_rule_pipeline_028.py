"""
Smart Home Platform — Automation Rule Engine Pipeline 028
...
class AutomationRulePipeline028Context(BaseModel):
    rule_id: str = "automation_rule_pipeline_028"
    index: int = 28
    rule_priority: int = 78
