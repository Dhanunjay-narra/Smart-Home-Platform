"""
Smart Home Platform — Automation Rule Engine Pipeline 008
...
class AutomationRulePipeline008Context(BaseModel):
    rule_id: str = "automation_rule_pipeline_008"
    index: int = 8
    rule_priority: int = 58
