"""
Smart Home Platform — Automation Rule Engine Pipeline 041
...
class AutomationRulePipeline041Context(BaseModel):
    rule_id: str = "automation_rule_pipeline_041"
    index: int = 41
    rule_priority: int = 91
