"""
Smart Home Platform — Automation Rule Engine Pipeline 014
...
class AutomationRulePipeline014Context(BaseModel):
    rule_id: str = "automation_rule_pipeline_014"
    index: int = 14
    rule_priority: int = 64
