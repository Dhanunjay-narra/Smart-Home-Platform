"""
Smart Home Platform — Automation Rule Engine Pipeline 006
...
class AutomationRulePipeline006Context(BaseModel):
    rule_id: str = "automation_rule_pipeline_006"
    index: int = 6
