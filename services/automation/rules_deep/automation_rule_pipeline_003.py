"""
Smart Home Platform — Automation Rule Engine Pipeline 003
...
class AutomationRulePipeline003Context(BaseModel):
    rule_id: str = "automation_rule_pipeline_003"
    index: int = 3
    rule_priority: int = 53
