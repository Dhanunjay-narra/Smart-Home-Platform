"""
Smart Home Platform — Automation Rule Engine Pipeline 020
...
class AutomationRulePipeline020Context(BaseModel):
    rule_id: str = "automation_rule_pipeline_020"
    index: int = 20
    rule_priority: int = 70
