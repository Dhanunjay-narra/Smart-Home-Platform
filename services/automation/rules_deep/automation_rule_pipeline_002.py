"""
Smart Home Platform — Automation Rule Engine Pipeline 002
...
class AutomationRulePipeline002Context(BaseModel):
    rule_id: str = "automation_rule_pipeline_002"
    index: int = 2
    rule_priority: int = 52
