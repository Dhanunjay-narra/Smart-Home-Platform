"""
Automation Scenario: WaterHeaterSolarSurplusDiverterRuleExecutor
Description: Modulates resistance water heater element using zero-crossing SSR when solar export > 1kW
"""
...
class WaterHeaterSolarSurplusDiverterRuleExecutorContext(BaseModel):
    scenario_id: str = "water_heater_solar_surplus_diverter"
    description: str = "Modulates resistance water heater element using zero-crossing SSR when solar export > 1kW"
    enabled: bool = True
...
class WaterHeaterSolarSurplusDiverterRuleExecutor:
    """Automated business logic handler for Modulates resistance water heater element using zero-crossing SSR when solar export > 1kW."""
    def __init__(self):
        self.context = WaterHeaterSolarSurplusDiverterRuleExecutorContext()
