"""
Smart Home Platform — Device Model: WeatherStationAnemometerDeviceModel
...
class WeatherStationAnemometerDeviceModelConfiguration(BaseModel):
    device_type: str = "weather_station_anemometer"
...
class WeatherStationAnemometerDeviceModelTelemetry(BaseModel):
...
class WeatherStationAnemometerDeviceModelDriver:
    """Enterprise device driver handling communication, telemetry processing, and safety loops."""
    def __init__(self, device_id: str = "dev-weather_station_anemometer-01"):
        self.device_id = device_id
        self.config = WeatherStationAnemometerDeviceModelConfiguration()
        self.telemetry = WeatherStationAnemometerDeviceModelTelemetry()
        self.state_history: List[WeatherStationAnemometerDeviceModelTelemetry] = []
    ...
    def ingest_sensor_frame(self, raw_input: float, temp_c: float = 35.0, voltage_v: float = 230.0) -> WeatherStationAnemometerDeviceModelTelemetry:
        ...
        t = WeatherStationAnemometerDeviceModelTelemetry(
