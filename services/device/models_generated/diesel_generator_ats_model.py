"""
Smart Home Platform — Device Model: DieselGeneratorAtsDeviceModel
...
class DieselGeneratorAtsDeviceModelConfiguration(BaseModel):
    device_type: str = "diesel_generator_ats"
...
class DieselGeneratorAtsDeviceModelTelemetry(BaseModel):
...
class DieselGeneratorAtsDeviceModelDriver:
    """Enterprise device driver handling communication, telemetry processing, and safety loops."""
    def __init__(self, device_id: str = "dev-diesel_generator_ats-01"):
        self.device_id = device_id
        self.config = DieselGeneratorAtsDeviceModelConfiguration()
        self.telemetry = DieselGeneratorAtsDeviceModelTelemetry()
        self.state_history: List[DieselGeneratorAtsDeviceModelTelemetry] = []
    ...
    def ingest_sensor_frame(self, raw_input: float, temp_c: float = 35.0, voltage_v: float = 230.0) -> DieselGeneratorAtsDeviceModelTelemetry:
        ...
        t = DieselGeneratorAtsDeviceModelTelemetry(
