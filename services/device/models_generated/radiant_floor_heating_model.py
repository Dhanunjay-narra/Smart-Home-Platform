"""
Smart Home Platform — Device Model: RadiantFloorHeatingDeviceModel
...
class RadiantFloorHeatingDeviceModelConfiguration(BaseModel):
    device_type: str = "radiant_floor_heating"
...
class RadiantFloorHeatingDeviceModelTelemetry(BaseModel):
...
class RadiantFloorHeatingDeviceModelDriver:
    """Enterprise device driver handling communication, telemetry processing, and safety loops."""
    def __init__(self, device_id: str = "dev-radiant_floor_heating-01"):
        self.device_id = device_id
        self.config = RadiantFloorHeatingDeviceModelConfiguration()
        self.telemetry = RadiantFloorHeatingDeviceModelTelemetry()
        self.state_history: List[RadiantFloorHeatingDeviceModelTelemetry] = []
    ...
    def ingest_sensor_frame(self, raw_input: float, temp_c: float = 35.0, voltage_v: float = 230.0) -> RadiantFloorHeatingDeviceModelTelemetry:
        ...
        t = RadiantFloorHeatingDeviceModelTelemetry(
