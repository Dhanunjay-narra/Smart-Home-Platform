"""
Smart Home Platform — Device Model: InverterSplitAcDeviceModel
...
class InverterSplitAcDeviceModelConfiguration(BaseModel):
    device_type: str = "inverter_split_ac"
...
class InverterSplitAcDeviceModelTelemetry(BaseModel):
...
class InverterSplitAcDeviceModelDriver:
    """Enterprise device driver handling communication, telemetry processing, and safety loops."""
    def __init__(self, device_id: str = "dev-inverter_split_ac-01"):
        self.device_id = device_id
        self.config = InverterSplitAcDeviceModelConfiguration()
        self.telemetry = InverterSplitAcDeviceModelTelemetry()
        self.state_history: List[InverterSplitAcDeviceModelTelemetry] = []
    ...
    def ingest_sensor_frame(self, raw_input: float, temp_c: float = 35.0, voltage_v: float = 230.0) -> InverterSplitAcDeviceModelTelemetry:
        ...
        t = InverterSplitAcDeviceModelTelemetry(
