"""
Smart Home Platform — Device Model: OpticalFlameDetectorDeviceModel
...
class OpticalFlameDetectorDeviceModelConfiguration(BaseModel):
    device_type: str = "optical_flame_detector"
...
class OpticalFlameDetectorDeviceModelTelemetry(BaseModel):
...
class OpticalFlameDetectorDeviceModelDriver:
    """Enterprise device driver handling communication, telemetry processing, and safety loops."""
    def __init__(self, device_id: str = "dev-optical_flame_detector-01"):
        self.device_id = device_id
        self.config = OpticalFlameDetectorDeviceModelConfiguration()
        self.telemetry = OpticalFlameDetectorDeviceModelTelemetry()
        self.state_history: List[OpticalFlameDetectorDeviceModelTelemetry] = []
    ...
    def ingest_sensor_frame(self, raw_input: float, temp_c: float = 35.0, voltage_v: float = 230.0) -> OpticalFlameDetectorDeviceModelTelemetry:
        ...
        t = OpticalFlameDetectorDeviceModelTelemetry(
