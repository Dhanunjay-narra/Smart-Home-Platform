"""
Smart Home Platform — Device Model: MotorizedBallValveDeviceModel
...
class MotorizedBallValveDeviceModelConfiguration(BaseModel):
    device_type: str = "motorized_ball_valve"
...
class MotorizedBallValveDeviceModelTelemetry(BaseModel):
...
class MotorizedBallValveDeviceModelDriver:
    """Enterprise device driver handling communication, telemetry processing, and safety loops."""
    def __init__(self, device_id: str = "dev-motorized_ball_valve-01"):
        self.device_id = device_id
        self.config = MotorizedBallValveDeviceModelConfiguration()
        self.telemetry = MotorizedBallValveDeviceModelTelemetry()
        self.state_history: List[MotorizedBallValveDeviceModelTelemetry] = []
    ...
    def ingest_sensor_frame(self, raw_input: float, temp_c: float = 35.0, voltage_v: float = 230.0) -> MotorizedBallValveDeviceModelTelemetry:
        ...
        t = MotorizedBallValveDeviceModelTelemetry(
