"""
Smart Home Platform — Device Model: ReverseOsmosisPurifierDeviceModel
...
class ReverseOsmosisPurifierDeviceModelConfiguration(BaseModel):
    device_type: str = "reverse_osmosis_purifier"
...
class ReverseOsmosisPurifierDeviceModelTelemetry(BaseModel):
...
class ReverseOsmosisPurifierDeviceModelDriver:
    """Enterprise device driver handling communication, telemetry processing, and safety loops."""
    def __init__(self, device_id: str = "dev-reverse_osmosis_purifier-01"):
        self.device_id = device_id
        self.config = ReverseOsmosisPurifierDeviceModelConfiguration()
        self.telemetry = ReverseOsmosisPurifierDeviceModelTelemetry()
        self.state_history: List[ReverseOsmosisPurifierDeviceModelTelemetry] = []
    ...
    def ingest_sensor_frame(self, raw_input: float, temp_c: float = 35.0, voltage_v: float = 230.0) -> ReverseOsmosisPurifierDeviceModelTelemetry:
        ...
        t = ReverseOsmosisPurifierDeviceModelTelemetry(
