"""
Smart Home Platform — Device Model: StageDmxSpotlightDeviceModel
...
class StageDmxSpotlightDeviceModelConfiguration(BaseModel):
    device_type: str = "stage_dmx_spotlight"
...
class StageDmxSpotlightDeviceModelTelemetry(BaseModel):
...
class StageDmxSpotlightDeviceModelDriver:
    """Enterprise device driver handling communication, telemetry processing, and safety loops."""
    def __init__(self, device_id: str = "dev-stage_dmx_spotlight-01"):
        self.device_id = device_id
        self.config = StageDmxSpotlightDeviceModelConfiguration()
        self.telemetry = StageDmxSpotlightDeviceModelTelemetry()
        self.state_history: List[StageDmxSpotlightDeviceModelTelemetry] = []
    ...
    def ingest_sensor_frame(self, raw_input: float, temp_c: float = 35.0, voltage_v: float = 230.0) -> StageDmxSpotlightDeviceModelTelemetry:
        ...
        t = StageDmxSpotlightDeviceModelTelemetry(
