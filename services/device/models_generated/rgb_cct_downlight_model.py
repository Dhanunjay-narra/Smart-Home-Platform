"""
Smart Home Platform — Device Model: RgbCctDownlightDeviceModel
...
class RgbCctDownlightDeviceModelConfiguration(BaseModel):
    device_type: str = "rgb_cct_downlight"
...
class RgbCctDownlightDeviceModelTelemetry(BaseModel):
...
class RgbCctDownlightDeviceModelDriver:
    """Enterprise device driver handling communication, telemetry processing, and safety loops."""
    def __init__(self, device_id: str = "dev-rgb_cct_downlight-01"):
        self.device_id = device_id
        self.config = RgbCctDownlightDeviceModelConfiguration()
        self.telemetry = RgbCctDownlightDeviceModelTelemetry()
        self.state_history: List[RgbCctDownlightDeviceModelTelemetry] = []
    ...
    def ingest_sensor_frame(self, raw_input: float, temp_c: float = 35.0, voltage_v: float = 230.0) -> RgbCctDownlightDeviceModelTelemetry:
        ...
        t = RgbCctDownlightDeviceModelTelemetry(
