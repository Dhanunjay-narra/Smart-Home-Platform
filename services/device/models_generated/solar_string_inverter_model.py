"""
Smart Home Platform — Device Model: SolarStringInverterDeviceModel
...
class SolarStringInverterDeviceModelConfiguration(BaseModel):
    device_type: str = "solar_string_inverter"
...
class SolarStringInverterDeviceModelTelemetry(BaseModel):
...
class SolarStringInverterDeviceModelDriver:
    """Enterprise device driver handling communication, telemetry processing, and safety loops."""
    def __init__(self, device_id: str = "dev-solar_string_inverter-01"):
        self.device_id = device_id
        self.config = SolarStringInverterDeviceModelConfiguration()
        self.telemetry = SolarStringInverterDeviceModelTelemetry()
        self.state_history: List[SolarStringInverterDeviceModelTelemetry] = []
    ...
    def ingest_sensor_frame(self, raw_input: float, temp_c: float = 35.0, voltage_v: float = 230.0) -> SolarStringInverterDeviceModelTelemetry:
        ...
        t = SolarStringInverterDeviceModelTelemetry(
