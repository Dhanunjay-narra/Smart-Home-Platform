"""
Smart Home Platform — Device Model: AwningPatioMotorDeviceModel
...
class AwningPatioMotorDeviceModelConfiguration(BaseModel):
    device_type: str = "awning_patio_motor"
...
class AwningPatioMotorDeviceModelTelemetry(BaseModel):
...
class AwningPatioMotorDeviceModelDriver:
    """Enterprise device driver handling communication, telemetry processing, and safety loops."""
    def __init__(self, device_id: str = "dev-awning_patio_motor-01"):
        self.device_id = device_id
        self.config = AwningPatioMotorDeviceModelConfiguration()
        self.telemetry = AwningPatioMotorDeviceModelTelemetry()
        self.state_history: List[AwningPatioMotorDeviceModelTelemetry] = []
    ...
    def ingest_sensor_frame(self, raw_input: float, temp_c: float = 35.0, voltage_v: float = 230.0) -> AwningPatioMotorDeviceModelTelemetry:
        ...
        t = AwningPatioMotorDeviceModelTelemetry(
