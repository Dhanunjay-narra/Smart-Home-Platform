"""
Smart Home Platform — Device Model: HepaAirPurifierDeviceModel
...
class HepaAirPurifierDeviceModelConfiguration(BaseModel):
    device_type: str = "hepa_air_purifier"
...
class HepaAirPurifierDeviceModelTelemetry(BaseModel):
...
class HepaAirPurifierDeviceModelDriver:
    """Enterprise device driver handling communication, telemetry processing, and safety loops."""
    def __init__(self, device_id: str = "dev-hepa_air_purifier-01"):
        self.device_id = device_id
        self.config = HepaAirPurifierDeviceModelConfiguration()
        self.telemetry = HepaAirPurifierDeviceModelTelemetry()
        self.state_history: List[HepaAirPurifierDeviceModelTelemetry] = []
    ...
    def ingest_sensor_frame(self, raw_input: float, temp_c: float = 35.0, voltage_v: float = 230.0) -> HepaAirPurifierDeviceModelTelemetry:
        ...
        t = HepaAirPurifierDeviceModelTelemetry(
