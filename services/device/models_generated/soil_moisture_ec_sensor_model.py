"""
Smart Home Platform — Device Model: SoilMoistureEcSensorDeviceModel
...
class SoilMoistureEcSensorDeviceModelConfiguration(BaseModel):
    device_type: str = "soil_moisture_ec_sensor"
...
class SoilMoistureEcSensorDeviceModelTelemetry(BaseModel):
...
class SoilMoistureEcSensorDeviceModelDriver:
    """Enterprise device driver handling communication, telemetry processing, and safety loops."""
    def __init__(self, device_id: str = "dev-soil_moisture_ec_sensor-01"):
        self.device_id = device_id
        self.config = SoilMoistureEcSensorDeviceModelConfiguration()
        self.telemetry = SoilMoistureEcSensorDeviceModelTelemetry()
        self.state_history: List[SoilMoistureEcSensorDeviceModelTelemetry] = []
    ...
    def ingest_sensor_frame(self, raw_input: float, temp_c: float = 35.0, voltage_v: float = 230.0) -> SoilMoistureEcSensorDeviceModelTelemetry:
        ...
        t = SoilMoistureEcSensorDeviceModelTelemetry(
