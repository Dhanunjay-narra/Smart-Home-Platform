"""
Smart Home Platform — Device Model: ExteriorPathLuminaireDeviceModel
...
class ExteriorPathLuminaireDeviceModelConfiguration(BaseModel):
    device_type: str = "exterior_path_luminaire"
...
class ExteriorPathLuminaireDeviceModelTelemetry(BaseModel):
...
class ExteriorPathLuminaireDeviceModelDriver:
    """Enterprise device driver handling communication, telemetry processing, and safety loops."""
    def __init__(self, device_id: str = "dev-exterior_path_luminaire-01"):
        self.device_id = device_id
        self.config = ExteriorPathLuminaireDeviceModelConfiguration()
        self.telemetry = ExteriorPathLuminaireDeviceModelTelemetry()
        self.state_history: List[ExteriorPathLuminaireDeviceModelTelemetry] = []
    ...
    def ingest_sensor_frame(self, raw_input: float, temp_c: float = 35.0, voltage_v: float = 230.0) -> ExteriorPathLuminaireDeviceModelTelemetry:
        ...
        t = ExteriorPathLuminaireDeviceModelTelemetry(
