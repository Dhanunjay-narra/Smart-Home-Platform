"""
Smart Home Platform — Device Model: RobotVacuumMopDeviceModel
...
class RobotVacuumMopDeviceModelConfiguration(BaseModel):
    device_type: str = "robot_vacuum_mop"
...
class RobotVacuumMopDeviceModelTelemetry(BaseModel):
...
class RobotVacuumMopDeviceModelDriver:
    """Enterprise device driver handling communication, telemetry processing, and safety loops."""
    def __init__(self, device_id: str = "dev-robot_vacuum_mop-01"):
        self.device_id = device_id
        self.config = RobotVacuumMopDeviceModelConfiguration()
        self.telemetry = RobotVacuumMopDeviceModelTelemetry()
        self.state_history: List[RobotVacuumMopDeviceModelTelemetry] = []
    ...
    def ingest_sensor_frame(self, raw_input: float, temp_c: float = 35.0, voltage_v: float = 230.0) -> RobotVacuumMopDeviceModelTelemetry:
        ...
        t = RobotVacuumMopDeviceModelTelemetry(
