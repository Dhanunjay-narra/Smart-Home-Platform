"""
Smart Home Platform Trait: AirQualityCapability
Description: Laser Scattering PM1.0/PM2.5/PM10 and Metal-Oxide VOC/NOx Index Trait
"""
...
class AirQualityCapabilityConfig(BaseModel):
    trait_id: str = "air_quality"
    display_name: str = "Air Quality"
...
class AirQualityCapabilityState(BaseModel):
    trait: str = "air_quality"
    raw_value: Any = None
...
class AirQualityCapabilityController:
    """Enterprise Controller handling state transitions and safety validation for AirQualityCapability."""
    def __init__(self, device_id: str = 'dev-node-001'):
        self.device_id = device_id
        self.config = AirQualityCapabilityConfig()
        self.state = AirQualityCapabilityState()
