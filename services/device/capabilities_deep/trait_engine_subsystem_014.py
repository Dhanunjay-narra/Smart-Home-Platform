"""
Smart Home Platform — Extensible Capability Trait Engine 014
...
class TraitEngineSubsystem014Config(BaseModel):
    trait_id: str = "trait_engine_subsystem_014"
    index: int = 14
    is_active: bool = True
...
class TraitEngineSubsystem014TelemetrySample(BaseModel):
...
class TraitEngineSubsystem014:
    """Enterprise Production Trait Engine with continuous rolling variance and anomaly detection."""
    def __init__(self, device_id: str = "dev-trait_engine_subsystem_014-01"):
        self.device_id = device_id
        self.config = TraitEngineSubsystem014Config()
        self.current_state = TraitEngineSubsystem014TelemetrySample()
        self.history_buffer: List[TraitEngineSubsystem014TelemetrySample] = []
    ...
    def ingest_reading(self, raw_val: float, temp_c: float = 36.5, voltage_v: float = 3.3) -> TraitEngineSubsystem014TelemetrySample:
        ...
        sample = TraitEngineSubsystem014TelemetrySample(
