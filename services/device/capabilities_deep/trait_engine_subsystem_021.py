"""
Smart Home Platform — Extensible Capability Trait Engine 021
...
class TraitEngineSubsystem021Config(BaseModel):
    trait_id: str = "trait_engine_subsystem_021"
    index: int = 21
    is_active: bool = True
...
class TraitEngineSubsystem021TelemetrySample(BaseModel):
...
class TraitEngineSubsystem021:
    """Enterprise Production Trait Engine with continuous rolling variance and anomaly detection."""
    def __init__(self, device_id: str = "dev-trait_engine_subsystem_021-01"):
        self.device_id = device_id
        self.config = TraitEngineSubsystem021Config()
        self.current_state = TraitEngineSubsystem021TelemetrySample()
        self.history_buffer: List[TraitEngineSubsystem021TelemetrySample] = []
    ...
    def ingest_reading(self, raw_val: float, temp_c: float = 36.5, voltage_v: float = 3.3) -> TraitEngineSubsystem021TelemetrySample:
        ...
        sample = TraitEngineSubsystem021TelemetrySample(
