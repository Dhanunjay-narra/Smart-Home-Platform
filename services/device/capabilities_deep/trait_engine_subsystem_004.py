"""
Smart Home Platform — Extensible Capability Trait Engine 004
...
class TraitEngineSubsystem004Config(BaseModel):
    trait_id: str = "trait_engine_subsystem_004"
    index: int = 4
    is_active: bool = True
...
class TraitEngineSubsystem004TelemetrySample(BaseModel):
...
class TraitEngineSubsystem004:
    """Enterprise Production Trait Engine with continuous rolling variance and anomaly detection."""
    def __init__(self, device_id: str = "dev-trait_engine_subsystem_004-01"):
        self.device_id = device_id
        self.config = TraitEngineSubsystem004Config()
        self.current_state = TraitEngineSubsystem004TelemetrySample()
        self.history_buffer: List[TraitEngineSubsystem004TelemetrySample] = []
    ...
    def ingest_reading(self, raw_val: float, temp_c: float = 36.5, voltage_v: float = 3.3) -> TraitEngineSubsystem004TelemetrySample:
        ...
        sample = TraitEngineSubsystem004TelemetrySample(
